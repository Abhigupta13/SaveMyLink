import {
  ...
  Library, Users, Newspaper, Upload, Wallet,
} from 'lucide-react';
...
export const NAV = [
  ...
  { href: '/expenses', Icon: Wallet, title: 'Expenses', desc: 'Track spending, investment & waste', hint: 'Log daily expenses, analyze weekly/monthly spending trends, and categorize investments vs wasted money.' },
...
// Phone bottom bar: daily-use core features, everything else lives in the Home grid
export const MOBILE_NAV = ['/links', '/notes', '/tasks', '/expenses', '/mom'];
